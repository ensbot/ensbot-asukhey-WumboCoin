...
from blockchain import Blockchain #IMPORT BLOCKCHAIN CLASS CREATED IN blockchain file
...
def mine_block():
    ...
    bc.addTransaction(sender=node_add,receiver='Akashneel',amt=2) #Implementing add transaction method
...
app.run(host='0.0.0.0', port =5003)   #Runs the application
